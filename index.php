...
<div class="mv wrapper">
    <div class="mv_inner wrapper_sp_lg">
...
<section class="skill wrapper" id="skill">
    ...
    <div class="section_inner wrapper_sp">
...
<section class="about wrapper">
    ...
    <div class="section_inner wrapper_sp">
        <div class="about_name_box">
            ...
            <a href="https://twitter.com/NaoyaError" class="sns" target="_blank"><img src="./image/twitter.png" alt="Twitterのアイコン" class="sns_icon"></a>
            <a href="https://github.com/Naoya7193" class="sns" target="_blank"><img src="./image/github.png" alt="GitHubのアイコン" class="sns_icon"></a>
            <a href="https://qiita.com/NaoyaError" class="sns" target="_blank"><img src="./image/qiita.png" alt="Qiitaのアイコン" class="sns_icon"></a>
        </div>
...
<!-- ビジョン -->
<div class="vision">
    <div class="vision_inner wrapper_sp">
        ...
        <p class="vision_maincopy">データを用いたサービスを提供する<br>アプリケーションの開発</p>
